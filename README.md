...
A COVID19 Tracker and Voice Assistant built with Django.
...
## Setting up the Project
  ...
  * Fork the Repository.
  * Clone the repository to your local machine `$ git clone https://github.com/<your-github-username>/COVID19_TRACKER_AND_VOICE_ASSISTANT.git`
  * Change directory to newspaper-app `$ cd COVID19_TRACKER_AND_VOICE_ASSISTANT`
